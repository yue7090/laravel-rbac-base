...
<div class="panel panel-yellow">
    ...
    <div class="panel-body pan">
        <form action="{{ route('role.update', ['id'=>$id]) }}" method="POST" class="form-horizontal form-seperated">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="inputFirstName" type="text" placeholder="First Name" class="form-control" name="name" value="{{$role['name']}}"/><span class="help-block">This is help text</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="inputFirstName" type="text" placeholder="First Name" class="form-control" name="display_name" value="{{$role['display_name']}}"/><span class="help-block">This is help text</span>
                    </div>
                </div>
                <div class="form-group">
