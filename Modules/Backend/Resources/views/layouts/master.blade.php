...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('vendors/jquery-treetable/stylesheets/jquery.treetable.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('vendors/jquery-treetable/stylesheets/jquery.treetable.theme.custom.css') }}">
    ...
    <script src="{{ asset('vendors/jquery-toastr/toastr.min.js') }}"></script>
...
&nbsp;<i class="fa fa-angle-down"></i></a>
                    ...
                    <ul class="nav navbar navbar-top-links navbar-right mbn">
                        <li class="dropdown topbar-user">
                            <a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="{{ asset('images/gallery/128.jpg') }}" alt="" class="img-responsive img-circle" />&nbsp;<span class="hidden-xs">{{Auth::guard()->user()->name}}</span>&nbsp;<span class="caret"></span>
                            </a>
