...
@section('content')
<link type="text/css" rel="stylesheet" href="{{ asset('vendors/jquery-nestable/nestable.css') }}">
<div class="panel">
            ...
            <div class="panel-body pan">
                ...
                <ol class="dd-list">
                    <?php
                        ...
                        {
                            echo menuTree($data, 'name', ['router','icon']);
                        }
                    ?>
                </ol>
                </div>
                        ...
                        <div class="form-body pal">
                            <div class="form-group">
                                ...
                                <div class="input-icon right"><i class="fa"></i>
                                    <input id="inputUsername" type="text" placeholder="标签" class="form-control" name="name">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right"><i class="fa"></i>
                                    <input id="inputUsername" type="text" placeholder="路由" class="form-control" name="router">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUsername" class="control-label">图标 <span class="require">*</span>
                                </label>
                                <div class="input-icon right"><i class="fa"></i>
                                    <input id="inputUsername" type="text" placeholder="图标" class="form-control" name="icon">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail" class="control-label">分类 <span class="require">*</span>
                                </label>
                                <select data-style="btn-white" class="selectpicker form-control show-tick" name="parent">
                                    <option value="0">====顶级分类====</option>
                                    @foreach($menuTreeList as $m)
    ...
    <div class="modal-dialog">
        <div class="modal-content panel panel-yellow">
            ...
            <div class="modal-body">
                <form action="" id="form" data-action="/backend/menu/__id" method="POST">
                    ...
                    <div class="form-body pal">
                        <div class="form-group">
                            ...
                            <div class="input-icon right"><i class="fa"></i>
                                <input id="name" type="text" placeholder="标签" class="form-control" name="name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail" class="control-label">路由 <span class="require">*</span>
                            ...
                            <div class="input-icon right"><i class="fa"></i>
                                <input id="router" type="text" placeholder="路由" class="form-control" name="router">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail" class="control-label">图标 <span class="require">*</span>
                            </label>
                            <div class="input-icon right"><i class="fa"></i>
                                <input id="icon" type="text" placeholder="图标" class="form-control" name="icon">
                            </div>
                        </div>
                    </div>
...
<script src="{{ asset('js/ui-nestable-list.js') }}"></script>
