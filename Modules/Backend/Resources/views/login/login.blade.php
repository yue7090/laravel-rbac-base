...
<head>
    ...
    <!--Loading style-->
    <link type="text/css" rel="stylesheet" href="{{ asset('css/themes/style1/pink-blue.css') }}" class="default-style">
    <link type="text/css" rel="stylesheet" href="{{ asset('css/themes/style1/pink-blue.css') }}" id="theme-change" class="style-change color-change">
