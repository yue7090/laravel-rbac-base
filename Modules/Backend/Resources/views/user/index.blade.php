        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ date('Y-m-d',strtotime($u->updated_at)) }}</td>
                    <td>
                        <a href="{{ route('user.edit',['id'=>$u->id]) }}" type="button" class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp; 修改
                        </a>
                        @if(!$u->is_super)
                        <button type="button" class="btn btn-default btn-xs btn-del" data-id="{{ $u->id }}"><i class="fa fa-trash-o btn-del" data-id="{{ $u->id }}"></i>&nbsp; 删除
                        </button>
                        @endif
                    </td>
                </tr>
