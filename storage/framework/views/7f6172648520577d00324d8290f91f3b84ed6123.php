        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(date('Y-m-d',strtotime($r->updated_at))); ?></td>
                    <td>
                        <a href="<?php echo e(route('role.edit',['id'=>$r->id])); ?>" type="button" class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp; 修改
                        </a>
                        <button type="button" class="btn btn-default btn-xs btn-del" data-id="<?php echo e($r->id); ?>"><i class="fa fa-trash-o btn-del" data-id="<?php echo e($r->id); ?>"></i>&nbsp; 删除
                        </button>
                    </td>
                </tr>
    ...
    $(".btn-del").click(function(){
        ...
        layer.confirm('确定删除?', {
            ...
            btn1: function(){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('backend/role')); ?>/"+id,
