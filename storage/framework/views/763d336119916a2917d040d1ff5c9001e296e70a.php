...
<div class="row mbl">
    ...
    <div class="actions" style="float:right; padding-right: 18px;">
        <a href="/backend/user/create" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>添加用户</a>
    </div>
</div>
        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($u->truename); ?></td>
                    <td>
                        <?php $__currentLoopData = $u->role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="label label-sm label-success"><?php echo e($role->name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </td>
                    <td><?php echo e(date('Y-m-d',strtotime($u->created_at))); ?></td>
                    <td><?php echo e(date('Y-m-d',strtotime($u->updated_at))); ?></td>
                    <td>
                        <a href="<?php echo e(route('user.edit',['id'=>$u->id])); ?>" type="button" class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp; 修改
                        </a>
                        <?php if(!$u->is_super): ?>
                        <button type="button" class="btn btn-default btn-xs btn-del" data-id="<?php echo e($u->id); ?>"><i class="fa fa-trash-o btn-del" data-id="<?php echo e($u->id); ?>"></i>&nbsp; 删除
                        </button>
                        <?php endif; ?>
                    </td>
                </tr>
    ...
    $(".btn-del").click(function(){
        ...
        layer.confirm('确定删除?', {
            ...
            btn1: function(){
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('backend/user')); ?>/"+id,
